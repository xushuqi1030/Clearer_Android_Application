...
public class CutFixedImage300View extends android.support.v7.widget.AppCompatImageView implements View.OnTouchListener{
    ...
    public CutFixedImage300View(Context context) {
        super(context);
        init(context, null, 0);
    }

    public CutFixedImage300View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public CutFixedImage300View(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setFloatRect() {
        ...
        mFloatRect = new RectF(left, top, 300, 300);
